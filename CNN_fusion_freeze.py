...
if __name__ == '__main__':
    ...
    if args.mode == 1:
        ...
        # CNN_features_train_flat = output_test[2]
        # np.save(WORKSPACE + '/feature_fusion_flat.npy', CNN_features_train_flat)
        #CNN_features_train_flat, CNN_features_train_dense2 = output_test[2], output_test[1]
        #np.save(WORKSPACE + '/feature_fusion_flat.npy', CNN_features_train_flat)
        #cnp.save(WORKSPACE + '/feature_maps_fusion_train_dense2.npy', CNN_features_train_dense2)
        ...
        np.save(WORKSPACE + '/conf_mat_val_fusion.npy', ConfusionMat)
        #CNN_features_train_flat = output_train[2]
        CNN_features_train_flat, CNN_features_train_dense2 = output_train[2], output_train[1]
        np.save(WORKSPACE + '/feature_fusion_flat.npy', CNN_features_train_flat)
        np.save(WORKSPACE + '/feature_maps_fusion_train_dense2.npy', CNN_features_train_dense2)
