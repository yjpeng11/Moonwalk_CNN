...
def build_model(args, weights_path_LSTM=None, output_feature = False):
    ...
    if sequenceout:
        ...
        output = Dense(args.num_classes, trainable=True, activation='softmax', init=my_init, name='new3_dense_6')(dropout)
...
if __name__ == '__main__':
    ...
    train_feature_path = os.path.join(WORKSPACE, 'train_data_feature_image.pik')
    ...
    test_feature_path = os.path.join(WORKSPACE, 'test_data_feature_image.pik')
    ...
    # set up callbacks
    CHECKPOINT_DIR = WORKSPACE + '/checkpoints_image_LSTM/'
    ...
    if args.mode == 0:  # training
        ...
        sio.savemat(WORKSPACE + '/feature_LSTM_image_val', {'LSTM_fea':LSTM_fea})
