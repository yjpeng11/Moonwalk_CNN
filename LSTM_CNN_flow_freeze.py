...
if __name__ == '__main__':
    ...
    train_feature_path = os.path.join(WORKSPACE, 'train_data_feature_flow.pik')
    ...
    test_feature_path = os.path.join(WORKSPACE, 'test_data_feature_flow.pik')
    ...
    # set up callbacks
    CHECKPOINT_DIR = WORKSPACE + '/checkpoints_flow_LSTM/'
    ...
    if args.mode == 0: # training
        ...
        print 'ConfusionMat:', ConfusionMat
        print 'score:', score
        sio.savemat(WORKSPACE + '/feature_LSTM_flow_val', {'LSTM_fea': LSTM_fea})
