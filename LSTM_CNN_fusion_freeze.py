...
def build_model(args, weights_path_LSTM=None, output_feature = False):
    ...
    if sequenceout:
        ...
        encoder = LSTM(args.nodes, trainable=False, return_sequences=True, name='lstm_1')(model_seq)
        ...
        encoder2 = LSTM(args.nodes, trainable=False, return_sequences=False, name='lstm_2')(model_seq)
        dropout = Dropout(0.75, name='dp_1')(encoder2)
        output = Dense(args.num_classes, trainable=True, activation='softmax', init=my_init, name='newnew_dense_6')(dropout)
...
if __name__ == '__main__':
    ...
    train_feature_path = os.path.join(WORKSPACE, 'train_data_feature_fusion.pik')
    ...
    test_feature_path = os.path.join(WORKSPACE, 'test_data_feature_fusion.pik')
